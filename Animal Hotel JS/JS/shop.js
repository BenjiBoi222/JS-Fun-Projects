...
import { calculateMaxSlots, calculateMaxWorkers } from "./utils.js";
...
function handleSlotsPurchase(event) {
    const slotAmountPlayerCanBuy = calculateMaxSlots(hotel.currentLevel);
...
function handleWorkerPurchase(event) {
    const workerAmountPlayerCanHire = calculateMaxWorkers(hotel.currentLevel);
